...
;(function () {
    ...
    Tree.CONFIG = {
        ...
        callback: {
            onCreateNode: function onCreateNode(treeNode, treeNodeDom) {}, // this = Tree
            onCreateNodeCollapseSwitch: function onCreateNodeCollapseSwitch(treeNode, treeNodeDom, switchDom) {}, // this = Tree
            onAfterAddNode: function onAfterAddNode(newTreeNode, parentTreeNode, nodeStructure) {}, // this = Tree
            onBeforeAddNode: function onBeforeAddNode(parentTreeNode, nodeStructure) {}, // this = Tree
            onAfterPositionNode: function onAfterPositionNode(treeNode, nodeDbIndex, containerCenter, treeCenter) {}, // this = Tree
            onBeforePositionNode: function onBeforePositionNode(treeNode, nodeDbIndex, containerCenter, treeCenter) {}, // this = Tree
            onToggleCollapseFinished: function onToggleCollapseFinished(treeNode, bIsCollapsed) {}, // this = Tree
            onAfterClickCollapseSwitch: function onAfterClickCollapseSwitch(nodeSwitch, event) {}, // this = TreeNode
            onBeforeClickCollapseSwitch: function onBeforeClickCollapseSwitch(nodeSwitch, event) {}, // this = TreeNode
            onTreeLoaded: function onTreeLoaded(rootTreeNode) {} // this = Tree
        }
    };
